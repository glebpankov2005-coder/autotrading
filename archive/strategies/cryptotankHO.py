...
class cryptotankHO(IStrategy):
    ...
    buy_ma_slope = DecimalParameter(-1.0, 0.10, default=-0.35, decimals=2, space="buy", optimize=True)

    sell_ma_slope = DecimalParameter(-0.10, 1.0, default=0.35, decimals=2, space="sell", optimize=True)
